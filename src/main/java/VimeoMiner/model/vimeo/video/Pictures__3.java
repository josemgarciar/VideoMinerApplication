...
public class Pictures__3 {
    ...
    @JsonProperty("sizes")
    public List<Size__2> getSizes() {
        return sizes;
    }

    @JsonProperty("sizes")
    public void setSizes(List<Size__2> sizes) {
        this.sizes = sizes;
    }
    ...
    public String toString() {
        ...
        sb.append(Pictures__3 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("uri");
        sb.append('=');
