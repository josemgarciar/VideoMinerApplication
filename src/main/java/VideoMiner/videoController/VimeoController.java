...
public class VimeoController {
    ...
    @GetMapping("/{id}")
    public Channel findOneVimeo(@PathVariable String id) throws ChannelNotFoundException {
        ...
        if(response.getBody() == null){
            ...
            return convertToChannel(response, id);
        }
    ...
    @PostMapping("/{id}")
    public Channel saveVimeo(@PathVariable String id) throws ChannelNotFoundException {
        Channel channel = findOneVimeo(id);
        channelRepository.save(channel);
        return channel;
    }

    private Channel convertToChannel(ResponseEntity<VimeoMiner.model.channel.Channel> response, String id) {
